...
<div class="row justify-content-md-center" style="min-height: 500px">
    ...
    <div class="col-lg-12 col-md-6">
        ...
        <a href="{{ route('admin.professor.showTable',['id'=>$professor->id]) }}" class="default-btn d-block m-auto mt-5" style="width: fit-content">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="trash" style="">
                                        <a title="عرض"  href="{{ route('admin.professor.showHall',['id'=>$h->id]) }}" class="show" style="color:blue;font-size:20px">
